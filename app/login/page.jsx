      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        {!profileFromUrl && (
          <div>
            ...
            <input type="text" value={profileId} onChange={(e) => setProfileId(e.target.value.toUpperCase())} placeholder="NCTV-10" className="w-full px-4 py-3 border-2 border-slate-200 rounded-xl bg-slate-50 text-lg font-mono tracking-wider" dir="ltr" disabled={loading} />
          </div>
        )}
        ...
        <div>
          ...
          <div className="relative">
            <input type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value.toUpperCase())} placeholder="ABC12345" className="w-full px-4 py-3 pe-12 border-2 border-slate-200 rounded-xl bg-slate-50 text-lg font-mono tracking-wider" dir="ltr" disabled={loading} />
